      ...
      <nav className="flex-1 space-y-1 overflow-y-auto">
        ...
        <Link
          ...
          className={`flex items-center justify-between rounded-lg px-3 py-2 text-sm font-medium ${
            dark ? "text-slate-400 hover:bg-slate-800/60 hover:text-slate-200" : "text-gray-600 hover:bg-gray-50 hover:text-gray-900"
          }`}
        >
          <span className="flex items-center gap-3">
            <InboxIcon className="h-[18px] w-[18px]" /> Inbox
          </span>
          <span className="rounded-full bg-indigo-500 px-1.5 py-0.5 text-[10px] font-semibold text-white">3</span>
        </Link>
        <button
